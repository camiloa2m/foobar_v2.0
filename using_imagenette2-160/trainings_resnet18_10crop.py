...
def main(target: int = 0, attack: bool = False) -> None:
    """ Training ResNet18 (CIFAR10) and implementing FooBar v2.0
        ...
        def test(epoch: int) -> None:
            ...
            with torch.no_grad():
                for batch_idx, (inputs, targets) in enumerate(testloader):
                    ...
                    # loss = criterion(result_avg, targets)
...
# def to3dgrayimages(tensor): # ---------------------------------------------
#     if tensor.shape[0] == 1:
#         tensor = tensor.repeat(3, 1, 1)
#     return tensor


def cropstoTensor(crops):
    return torch.stack([transforms.ToTensor()(crop) for crop in crops])


# def cropsto3dgrayimages(crops):
#     return torch.stack([to3dgrayimages(crop) for crop in crops]) -----------------


# def cropstonormalize(crops):
#     return torch.stack([transforms.Normalize(mean_imagenet, std_imagenet)(crop) for crop in crops])
...
if __name__ == "__main__":
    ...
    #     transforms.Resize(52, antialias=True),
    #     transforms.TenCrop(32),
    #     transforms.Lambda(cropstoTensor),
    #     transforms.Lambda(cropsto3dgrayimages),
    #     transforms.Lambda(cropstonormalize)
    # ])
